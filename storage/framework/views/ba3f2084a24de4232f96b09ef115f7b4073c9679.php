...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('bootstrap-5.0.0/css/bootstrap.min.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('bootstrap-5.0.0/js/bootstrap.min.js')); ?>"></script>
    
    <?php echo $__env->yieldContent('scripts'); ?>
</body>
</html><?php /**PATH E:\src-laravel-test\example-app\resources\views/layouts/master.blade.php ENDPATH**/ ?>